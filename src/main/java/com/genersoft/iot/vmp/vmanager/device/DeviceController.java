...
public class DeviceController {
	...
	public ResponseEntity<PageInfo> channels(@PathVariable String deviceId, int page, int count,
	...
	public ResponseEntity<PageInfo> subChannels(@PathVariable String deviceId, @PathVariable String channelId, int page,
			int count, @RequestParam(required = false) String query, @RequestParam(required = false) String online,
			@RequestParam(required = false) Boolean channelType) {
